...
body_1.SetPos(chrono.ChVectorD(0.025,0.00499999999999999,0.435))
...
body_1.SetInertiaXY(chrono.ChVectorD(4.46677530778635e-20,5.97501259547907e-20,1.53730203414675e-20))
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-3.36588702235453e-18,-5.08981923069003e-18,0.18),chrono.ChQuaternionD(1,0,0,0)))
...
body_2.SetName('Main_leg-2')
body_2.SetPos(chrono.ChVectorD(0.025,-0.295,0.485))
...
body_2.SetInertiaXY(chrono.ChVectorD(4.46677530778635e-20,-5.97501259547907e-20,-1.5404988211714e-20))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-3.36588702235453e-18,-5.08981923069003e-18,0.18),chrono.ChQuaternionD(1,0,0,0)))
...
body_3.SetPos(chrono.ChVectorD(0.025,-0.025,0.05))
body_3.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_3.SetMass(0.723285413235575)
body_3.SetInertiaXX(chrono.ChVectorD(0.00799207954939873,0.00799207954939873,0.00036119417290903))
body_3.SetInertiaXY(chrono.ChVectorD(4.02006102661444e-36,1.15648231731788e-20,-8.61597626531233e-36))
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(5.59251337018444e-18,1.27149367289098e-18,0.18),chrono.ChQuaternionD(1,0,0,0)))
...
body_4.SetInertiaXX(chrono.ChVectorD(0.000216025953973108,0.00338823977615053,0.00338363272051758))
body_4.SetInertiaXY(chrono.ChVectorD(-4.46677530778635e-20,5.97501259547907e-20,-1.5628763303439e-20))
body_4.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-3.36588702235453e-18,-5.08981923069003e-18,0.18),chrono.ChQuaternionD(1,0,0,0)))
...
body_5.SetInertiaXY(chrono.ChVectorD(-4.46677530778635e-20,-5.97501259547907e-20,1.54689239522068e-20))
body_5.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-3.36588702235453e-18,-5.08981923069003e-18,0.18),chrono.ChQuaternionD(1,0,0,0)))
...
link_5.Initialize(body_3,body_5,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,0,-1)
dB = chrono.ChVectorD(0,0,1)
link_6.Initialize(body_3,body_5,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,0,-1)
dB = chrono.ChVectorD(0,0,1)
link_7.Initialize(body_3,body_5,False,cA,cB,dB)
...
link_8.Initialize(body_3,body_5,False,cA,cB,dA,dB)
...
#   Entity 1: C::E name: body_2 , SW name: Main_leg-2 ,  SW ref.type:2 (2)
...
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(0,0,-1)
link_15.Initialize(body_1,body_2,False,cA,cB,dB)
...
link_16.Initialize(body_1,body_2,False,cA,cB,dA,dB)
...
link_21.Initialize(body_3,body_1,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0.05,-0.355,0.41)
dB = chrono.ChVectorD(1,6.93889390390723e-18,0)
link_22.Initialize(body_3,body_1,False,cA,cB,dA,dB)
...
link_27.Initialize(body_3,body_0,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(0,1,0)
link_28.Initialize(body_3,body_0,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-1,0,0)
dB = chrono.ChVectorD(1,0,0)
link_29.Initialize(body_3,body_0,False,cA,cB,dB)
...
link_30.Initialize(body_3,body_0,False,cA,cB,dA,dB)
